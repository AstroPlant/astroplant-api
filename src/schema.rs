...
table! {
    ...
    kit_configurations (id) {
        ...
        /// The `rules_supervisor_module_name` column of the `kit_configurations` table.
        ///
        /// Its SQL type is `Text`.
        ///
        /// (Automatically generated by Diesel.)
        rules_supervisor_module_name -> Text,
        /// The `rules_supervisor_class_name` column of the `kit_configurations` table.
        ///
        /// Its SQL type is `Text`.
        ///
        /// (Automatically generated by Diesel.)
        rules_supervisor_class_name -> Text,
        /// The `rules` column of the `kit_configurations` table.
        ///
        /// Its SQL type is `Json`.
        ///
        /// (Automatically generated by Diesel.)
